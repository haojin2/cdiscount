...
def main(argv):
  ...
  for layer in model.layers[1].layers[:15]:
    layer.trainable = False
  for layer in model.layers[1].layers[15:19]:
    layer.trainable = True
  for layer in model.layers[1].layers[19:]:
    layer.trainable = False
  ...
  for layer in model.layers[1].layers[:11]:
    layer.trainable = False
  for layer in model.layers[1].layers[11:15]:
    layer.trainable = True
  for layer in model.layers[1].layers[15:]:
    layer.trainable = False
  ...
  for layer in model.layers[1].layers[:7]:
    layer.trainable = False
  for layer in model.layers[1].layers[7:11]:
    layer.trainable = True
  for layer in model.layers[1].layers[11:]:
    layer.trainable = False
  ...
  for layer in model.layers[1].layers[:4]:
    layer.trainable = False
  for layer in model.layers[1].layers[4:7]:
    layer.trainable = True
  for layer in model.layers[1].layers[7:]:
    layer.trainable = False
  ...
  for layer in model.layers[1].layers[:1]:
    layer.trainable = False
  for layer in model.layers[1].layers[1:4]:
    layer.trainable = True
  for layer in model.layers[1].layers[4:]:
    layer.trainable = False
